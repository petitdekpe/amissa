 ...
 */
final class Version20260202152238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE diocese ADD fedapay_public_key VARCHAR(255) DEFAULT NULL, CHANGE fedapay_api_key fedapay_secret_key VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE diocese ADD fedapay_api_key VARCHAR(255) DEFAULT NULL, DROP fedapay_secret_key, DROP fedapay_public_key');
