 ...
 */
final class Version20260202111619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intention_messe ADD texte_intention LONGTEXT DEFAULT NULL, CHANGE beneficiaire beneficiaire VARCHAR(255) DEFAULT NULL, CHANGE type_intention type_intention VARCHAR(100) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intention_messe DROP texte_intention, CHANGE beneficiaire beneficiaire VARCHAR(255) NOT NULL, CHANGE type_intention type_intention VARCHAR(100) NOT NULL');
